...
export function ResumePreview({ language, pageSize }: ResumePreviewProps) {
  const { resumeData, selectedTemplate, sectionOrder, updateSectionOrder } =
    useResume();
  ...
  return (
    <div className="w-full h-full overflow-auto bg-gray-100 p-4 md:p-8 flex justify-center items-start">
